#!/bin/bash
# SBATCH script to run baseline training on 1 GPU
#SBATCH -J transformers_train_baseline
...
TRAIN_PY="$REPO_ROOT/baseline/train.py"
...
echo "Starting baseline training: python $TRAIN_PY ${ARGS[*]}"
